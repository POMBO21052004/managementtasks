...
import "../../assets/layout/css/SideBar.css";
import "../../assets/layout/css/NavBar.css";
...
export default function AppLayout({ children }) {
  ...
  // Détermine les composants à utiliser selon le rôle
  const NavbarComponent = EmployeNavbar;
  const SidebarComponent = EmployeSidebar;
  ...
  return (
    <div className="d-flex min-vh-100">
      ...
      {/* Sidebar */}
      <SidebarComponent user={user} collapsed={!sidebarVisible} />
