// components/Employee/Tasks/Create.jsx
...
export default function EmployeeTaskCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const submitData = {
        ...formData,
        project: formData.project || null // Convertir chaine vide en null
      };
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            ...
            <p className={`mb-0 ${theme === "dark" ? "text-light" : "text-muted"}`}>
              Création d'une nouvelle tâche personnelle
            </p>
          </div>
          <Button 
                ...
                <Card.Body>
                  <div className="small">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <span>Statut: {loadingProjects ? 'Chargement...' : 'Prêt'}</span>
                    </div>
                  </div>
                </Card.Body>
              </Card>
